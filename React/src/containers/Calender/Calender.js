...
class Calender extends Component {
    ...
    state = {
        ...
        tasks: [
            {
                name: "clean room",
                description: "I have to clean my room before my Roomate comes home",
                assignedTo: ["GSC", "SH"],
                dateDue: "2018-10-22T04:00:00.000Z",
                timeDue: "2018-10-22T16:21:49.158Z",
                isRecurring: false,
            ...
            {
                name: "take out trash",
                description: "I have to take out trash before my roomates gets pissed",
                assignedTo: ["GSC", "SH"],
